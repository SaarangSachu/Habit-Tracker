...
class App(ctk.CTk):
    ...
    def cancel_edit(self):
        ...
        self.action_btn.configure(text="+ Add", fg_color="#2CC985")
    ...
    def show_analytics(self): 
        self.clear_frame()
        AnalyticsPanel(self.main_area, self.db).pack(fill="both", expand=True)

    def show_performance(self):
        self.clear_frame()
        PerformancePanel(self.main_area, self.db).pack(fill="both", expand=True)
